...
version = intake_telemetry.__version__
# The full version, including alpha/beta/rc tags.
release = intake_telemetry.__version__
...
latex_documents = [
    (master_doc, 'intake_telemetry.tex',
     'intake-telemetry Documentation',
     'Charles Turner', 'manual'),
]
